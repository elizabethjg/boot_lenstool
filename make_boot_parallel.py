...
def run_lenstool_parallel(folder,ini,ncores):            
      ...
      backgx = np.loadtxt(folder+'/background_galaxies_parallel.lenstool')
      
      infile = open(folder+'/background_galaxies_parallel.lenstool', 'r')
      ...
      for j in np.arange(ini,ini+ncores):
            ...
            np.savetxt( folder+'_'+str(j)+'/background_galaxies_parallel.lenstool',lenstool_catalogue,\
